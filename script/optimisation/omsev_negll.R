...
base_params <- c(0.77, 4.7, 0.1, 0.71, 1, 4) # from optim with eta1 = 1

foldername <- paste0(im_folder, "optim/omsev/profiles/")
...
profiles <- list(
  list(name = "eta1",   grid = c(0, seq(-1, 1, length.out = 30)), index = 5, wind_df = -V_episodes),
  list(name = "eta2",   grid = seq(0, 10, length.out = 30), index = 6, wind_df = -V_episodes)
)
