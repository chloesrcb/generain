...
png("../images/optim/density_100s_100t_byq.png")
...
q_values <- c(0.7, 0.75, 0.8, 0.85, 0.9) # quantiles
...
png("../images/optim/contour_100s_100t_betas_q85.png")
...
```{r}
fixed_params <- c(0.4, 0.2, 1.5, 1)
param1_values <- seq(0.5, 1.9, length.out = 50)
param2_values <- seq(0.5, 1.9, length.out = 50)
...
png("../images/optim/contour_25s_300t_alphas_q92.png")
contour(param1_values, param2_values, nll_matrix, nlevels = 20, 
...
print(result_1$par)
# sur deux simu
simu1 <- simu_list[[4]] # [1] 0.2363283 0.3130344 1.4740192 0.6683990
simu2 <- simu_list[[12]] # [1] 0.5024269 0.1990440 1.4421766 0.9519488
list_simu12 <- list(simu1, simu2)
excesses1 <- list_excesses[[4]]
excesses2 <- list_excesses[[12]]
