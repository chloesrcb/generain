...
We initialize the parameters with the values obtained from the WLSE method and we 
consider an advection of 0.1 for both directions. It converges and the results of 
...
```{r, echo=FALSE, fig.width = 5, fig.height = 3, fig.cap="Variogram estimate"}
