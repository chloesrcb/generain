...
# SIMULATION
adv <- c(0.2, 0.1) # advection
params <- c(0.01, 0.2, 1.5, 1) # ok verif sur simu
...
param_str <- sprintf("%03d_%02d_%02d_%02d", true_param[1] * 100,
