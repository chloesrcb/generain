...
df_lags <- get_conditional_lag_vectors(sites_coords, true_param, tamp, s0, t0,
                                        tau_max = 10)
df_lags_chi <- theorical_chi(true_param, df_lags) # get chi matrix
...
write.csv(df_result, paste0(foldername, "result_optim_all_25s_30t_100.csv"))

# get csv
df_result <- read.csv(paste0(foldername, "result_optim_all.csv"))
kable(df_result, "latex", booktabs = TRUE,
...
```
<!-- result pour premiere optim avec hmax=NA et true_param
$par
[1] 0.265319937 0.063424034 1.999000000 1.416867539 0.005854803 0.070094165
...
# $r$-Pareto process with advection
